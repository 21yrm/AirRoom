...
from third_party.SemanticSAM.utils.arguments import load_opt_from_config_file
from third_party.SemanticSAM.semantic_sam.BaseModel import BaseModel
from third_party.SemanticSAM.semantic_sam import build_model
from third_party.SemanticSAM.tasks.automatic_mask_generator import SemanticSamAutomaticMaskGenerator
from third_party.SemanticSAM.tasks.interactive_idino_m2m_auto import show_anns
from third_party.SemanticSAM.tasks.interactive_predictor import SemanticSAMPredictor
...
def prepare_image(image_pth):
    ...
    t = []
    t.append(transforms.Resize(480, interpolation=Image.BICUBIC))
...
def build_semantic_sam(model_type, ckpt):
    ...
    cfgs = {
        'T': root / "configs" / "semantic_sam_only_sa-1b_swinT.yaml",
        'L': root / "configs" / "semantic_sam_only_sa-1b_swinL.yaml"
    }
